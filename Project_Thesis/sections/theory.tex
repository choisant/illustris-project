...
Where $\sigma (R)$ is the variance of the field with a smoothing radius R, $\overline{\rho}$ is the mean density of the universe and $f(\sigma)$ is the multiplicity function. For that paper, $f(\sigma)$ was found to be
